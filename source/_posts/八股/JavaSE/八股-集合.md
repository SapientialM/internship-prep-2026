...
![image.png](八股-集合/1740280307408-daeefff4-a9c4-4988-8f88-e480615829f4.png)



![image.png](八股-集合/1740280331602-74c08ca4-9376-4db8-9712-06c635411de7.png)
...
![jdk1.8 之前的内部结构-HashMap](八股-集合/jdk1.7_hashmap.png)

- JDK1.8+：数组+链表+红黑树

![jdk1.8之后的内部结构-HashMap](八股-集合/jdk1.8_hashmap.png)
...
![Java 7 ConcurrentHashMap 存储结构](八股-集合/java7_concurrenthashmap.png)

JDK8（Node + 链表/红黑树）：

![Java8 ConcurrentHashMap 存储结构（图片来自 javadoop）](八股-集合/java8_concurrenthashmap.png)
